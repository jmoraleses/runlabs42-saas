    ...
    sections: [
      {
        ...
        paragraphs: [
          `Verantwortlicher für die Verarbeitung personenbezogener Daten im Zusammenhang mit ${COMPANY} ist die auf runlabs42.com betreibende Stelle (nachfolgend „${COMPANY}“ oder „wir“).`,
