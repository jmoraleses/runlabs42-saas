    ...
    sections: [
      {
        ...
        paragraphs: [
          `El responsable del tratamiento de los datos personales en relación con ${COMPANY} es la entidad que opera la plataforma en runlabs42.com (en adelante, «${COMPANY}» o «nosotros»).`,
