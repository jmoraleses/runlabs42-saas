    ...
    sections: [
      {
        ...
        paragraphs: [
          `The data controller responsible for processing personal data in connection with ${COMPANY} is the entity operating the platform (hereinafter "${COMPANY}" or "we").`,
