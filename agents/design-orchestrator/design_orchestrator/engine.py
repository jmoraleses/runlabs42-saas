"""
Orquestador de diseño para Vertex AI Agent Engine.
...
class DesignOrchestratorAgent:
    ...
    def _tool_generate_layout(
        ...
        text = _generate_text(
            ...
            system_instruction=LAYOUT_INSTRUCTION_DESKTOP,
            model_id=model_id,
            response_mime_type="application/json",
        )
        parsed = _extract_json(text)
    ...
    def run_orchestration(
        ...
        *,
        ...
        model = model_id or os.environ.get("DESIGN_GEN_MODEL", "gemini-3.1-flash-lite")
